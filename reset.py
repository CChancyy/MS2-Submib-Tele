...
db.collection('washers').document('washers1').set(data)
db.collection('washers').document('washers2').set(data)
db.collection('washers').document('washers3').set(data)
db.collection('washers').document('washers4').set(data)
db.collection('washers').document('washers5').set(data)
db.collection('washers').document('washers6').set(data)
db.collection('washers').document('washers7').set(data)
db.collection('washers').document('washers8').set(data)